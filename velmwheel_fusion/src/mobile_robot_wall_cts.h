...
#define PRIOR_COV_X pow(0.00001,2)
#define PRIOR_COV_Y pow(0.00001,2)
#define PRIOR_COV_THETA pow(0.00001,2)

// FOR MIXTURE
// Initial estimate of position and orientation
#define PRIOR_MU_X1 0.0
#define PRIOR_MU_Y1 0.0
#define PRIOR_MU_THETA1 0	//M_PI/4
// Initial covariances of position and orientation
#define PRIOR_COV_X1 pow(0.00001,2)
#define PRIOR_COV_Y1 pow(0.00001,2)
#define PRIOR_COV_THETA1 pow(0.00001,2)
// Initial estimate of position and orientation
#define PRIOR_MU_X2 0.0
#define PRIOR_MU_Y2 0.0
#define PRIOR_MU_THETA2 0	//M_PI/4
// Initial covariances of position and orientation
#define PRIOR_COV_X2 pow(0.00001,2)
#define PRIOR_COV_Y2 pow(0.00001,2)
#define PRIOR_COV_THETA2 pow(0.00001,2)
// Initial estimate of position and orientation
#define PRIOR_MU_X3 0.0
#define PRIOR_MU_Y3 0.0
#define PRIOR_MU_THETA3 0	//M_PI/4
// Initial covariances of position and orientation
#define PRIOR_COV_X3 pow(0.00001,2)
#define PRIOR_COV_Y3 pow(0.00001,2)
#define PRIOR_COV_THETA3 pow(0.00001,2)
// Initial estimate of position and orientation
#define PRIOR_MU_X4 0.0
#define PRIOR_MU_Y4 0.0
#define PRIOR_MU_THETA4 0	//M_PI/4
// Initial covariances of position and orientation
#define PRIOR_COV_X4 pow(0.00001,2)
#define PRIOR_COV_Y4 pow(0.00001,2)
#define PRIOR_COV_THETA4 pow(0.00001,2)

// System Noise
#define MU_SYSTEM_NOISE_X 0.0 
#define MU_SYSTEM_NOISE_Y 0.0 
#define MU_SYSTEM_NOISE_THETA 0.0
#define SIGMA_SYSTEM_NOISE_X pow(0.1,1)
#define SIGMA_SYSTEM_NOISE_Y pow(0.00001,2)
#define SIGMA_SYSTEM_NOISE_THETA pow(0.00001,2)
...
#define SIGMA_SYSTEM_NOISE_X_ROB pow(0.00001,2)
#define SIGMA_SYSTEM_NOISE_Y_ROB pow(0.00001,2)
#define SIGMA_SYSTEM_NOISE_THETA_ROB pow(0.00001,2)
...
// Measurement noise
#define SIGMA_MEAS_NOISE pow(0.00000000001,2)
#define MU_MEAS_NOISE 0.0

// Measurement noise for mobile robot simulator 
#define SIGMA_MEAS_NOISE_ROB pow(0.00001,2)
