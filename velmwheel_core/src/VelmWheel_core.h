...
class VelmWheelCore : public RTT::TaskContext
{
	...
	private:
		...
		bool startHook();
 		...
 		RTT::InputPort<long long int> in_wrr_enc_;
 		RTT::InputPort<long long int> in_wrl_enc_;
 		RTT::InputPort<long long int> in_wfr_enc_;
 		RTT::InputPort<long long int> in_wfl_enc_;
